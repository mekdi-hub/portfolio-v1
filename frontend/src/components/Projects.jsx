        ...
        {loading ? (
          ...
          <div className="projects-grid">
            {projects.map((project, index) => (
              ...
              >
                <div className="project-card-media" onClick={() => openProjectDetails(project)}>
                ...
                <div className="project-card-content">
                  ...
                  <div className="project-actions">
                    <button onClick={() => openProjectDetails(project)} className="project-btn primary">
                    ...
                    {project.demo_link && (
                      <a href={project.demo_link} target="_blank" rel="noopener noreferrer" className="project-btn secondary">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <div className="project-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-content">
              <div className="modal-media">
                {selectedProject.image && selectedProject.image.includes('youtube.com') ? (
                  <iframe
                    src={selectedProject.image.replace('watch?v=', 'embed/')}
                    title={selectedProject.title}
                    frameBorder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowFullScreen
                  />
                ) : selectedProject.image && (selectedProject.image.endsWith('.mp4') || selectedProject.image.endsWith('.webm')) ? (
                  <video 
              ...
              <div className="modal-details">
                ...
                <div className="modal-actions">
                  {selectedProject.demo_link && (
                    <a href={selectedProject.demo_link} target="_blank" rel="noopener noreferrer" className="modal-btn primary">
                  ...
                  {selectedProject.github_link && (
                    <a href={selectedProject.github_link} target="_blank" rel="noopener noreferrer" className="modal-btn secondary">
